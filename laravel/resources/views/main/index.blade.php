					...
					<div>
						<form class="form-horizontal" id="add_data" action="{{ route('main.update_action') }}" method="post" onclick="return false;" autocomplete="off">
							...
							<div class="form-group">
								<label class="col-sm-3 control-label">填寫人：</label>
								<div class="col-sm-9">
									<input class="form-control add_data_text" id="form_name" name="form_name" type="text" value="" disabled="disabled" disabled="disabled">
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-3 control-label">預計完成時間：</label>
								<div class="col-sm-9">
									<input class="form-control add_data_text" id="form_finish_time" name="form_finish_time" type="text" value="" disabled="disabled">
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-3 control-label">內容：</label>
								<div class="col-sm-9">
									<textarea class="form-control add_data_text" rows="5" id="form_content" name="form_content" disabled="disabled"></textarea>
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-3 control-label">備註：</label>
								<div class="col-sm-9">
									<input class="form-control" id="form_remark" name="form_remark" type="text" value="" disabled="disabled">
								</div>
							</div>
							<div class="form-group">
